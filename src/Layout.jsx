...
export default function Layout({ children, currentPageName }) {
  ...
  const navItems = [
  { name: 'Home', icon: () => <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/695b603a6d9b50e34c2be229/28e3f8f94_CpiadePenSell3.jpg" alt="Home" className="w-12 h-12 object-contain" />, page: 'Home' },
