...
export default function Layout({ children, currentPageName }) {
  ...
  const navItems = [
  { name: '', icon: () => <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/695b603a6d9b50e34c2be229/e154f2940_Designsemnome1.png" alt="Home" className="w-12 h-12 object-contain" />, page: 'Home' },
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-slate-200 z-40">
        <div className="flex items-center justify-center h-14 relative">
          <div className="absolute left-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="h-14 w-14 rounded-full flex items-center justify-center hover:bg-slate-100 transition-colors relative p-0">
