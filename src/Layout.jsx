...
export default function Layout({ children, currentPageName }) {
  ...
  const navItems = [
  { name: 'Home', icon: () => <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/695b603a6d9b50e34c2be229/318bb709f_CpiadePenSell3.jpg" alt="Home" className="w-8 h-8 object-contain" />, page: 'Home' },
